...
- [Introducing Udev on Oracle Linux](https://youtu.be/9UQs1ca5Uwk)
- [[ENG] Christian Brauner: "Making the Kernel and Udev Namespace Aware" / #LinuxPiter](https://youtu.be/ondREXbSa5E)
...
- [*udev: Function Flow for KOBJECT_UEVENT kernel group message*](https://insujang.github.io/2018-11-28/udev-function-flow-for-kobject_uevent-kernel-group-message/)
